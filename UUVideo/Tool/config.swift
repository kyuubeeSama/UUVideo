...
// 站点标题
let indexArr = [(title:"站点",list:["本地视频", "新番时间表", "哈哩哈哩","来快播","樱花动漫","剧知晓"]),(title:"个人中心",list:["历史记录","我的收藏"])]
// 站点地址
let urlArr = ["http://halihali2.com/", "https://www.laikuaibo.com/","http://www.yhdm.so/","https://www.qybfb.com/"]
